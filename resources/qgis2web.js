...
map.getView().fit([461389.360167, 152274.662713, 2286914.875378, 1501195.892562], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">FORMATIONS GEOLOGIQUES DU CAMEROUN</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (158 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ce projet regroupe les éléments de géologie du Cameroun, notamment les formations géologiques & les linéaments. Ces éléments sont suscptibles de mise à jour. ';
            }
